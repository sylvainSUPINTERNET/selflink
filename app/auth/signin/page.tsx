...
function displaySocialBtn(provider: any) {
    ...
    <div key={provider.name}>
        {provider.name === "Google" && (
            <div className="my-4">
                <button type="button"
                        className="border-solid border-2 border-indigo-600 text-xl py-2 px-4 flex justify-center items-center text-white w-full transition ease-in duration-200 text-center font-semibold shadow-md focus:outline-none rounded-lg bg-gradient-to-r from-blue-800 to-purple-600 hover:bg-gradient-to-br focus:ring-4 focus:ring-purple-300 dark:focus:ring-purple-900"
        ...
        {provider.name === "Facebook" && (
            <div className="my-4">
                <button type="button"
                    ...
                    <span className="ml-2">Continuer avec Meta</span>
                </button>
            </div>
        )}
                ...
                <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div>
                        <a href="#" className="flex justify-center items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            <div className="self-center text-2xl md:text-4xl font-extrabold text-gray leading-1 tracking-tighter text-center">
                                <p>Self <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-pink-500">Link</span></p>
                            </div>
                        </a>
                    </div>

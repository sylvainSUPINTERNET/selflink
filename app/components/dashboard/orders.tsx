    ...
    return <>
        ...
        <div className="mt-2 p-2 mb-3">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-4 mb-4">
                    {tagged.length > 0 ? (
                    <button
                        className="btn-primary text-white font-bold py-2 px-4 rounded-lg w-full sm:w-auto transition duration-300 ease-in-out transform hover:scale-105 shadow-lg"
                        onClick={e => {
                        saveOrderStatus();
                        }}
                    >
                    ...
                    <button
                        className="bg-gray-300 text-white font-bold py-2 px-4 rounded-lg w-full sm:w-auto cursor-not-allowed"
                        disabled
                    >
                        Sauvegarder
                    </button>
                    ...
                    stock > 0 ?
                    <a 
                        className="btn-primary  text-white font-bold py-2 px-4 rounded-lg w-full sm:w-auto transition duration-300 ease-in-out transform hover:scale-105 shadow-lg flex justify-center items-center" 
                        target="_blank" 
                        href={paymentLinkInitUrl}
                    >
                        Voir le lien
                    </a>
                    :
                    <a 
                        className="bg-gray-300 text-white font-bold py-2 px-4 rounded-lg w-full sm:w-auto cursor-not-allowed flex justify-center items-center" 
                    >
                        {/* SVG icon and text */}
                        {/* SVG code remains the same */}
                        Lien désactivé { stock === 0 ? " (stock épuisé)" : ""}
                    </a>
                    }
                </div>
                </div>
...

        {
            paymentLinkInitUrl && (
                ...
                <div className="flex items-center">
                    <span className="inline-block rounded-full bg-indigo-100 px-3 py-1 text-sm font-semibold text-indigo-800 mr-2 ring ring-indigo-200">Total</span>
                ...
                {/* STOCK Information Tag */}
                {stock > 0 ? (
                    <div className="flex items-center">
                    <span className="inline-block rounded-full bg-green-100 px-3 py-1 text-sm font-semibold text-green-800 mr-2 ring ring-green-200">Stock</span>
                    <span className="text-sm">{stock}</span>
                    </div>
                ) : (
                    <div className="flex items-center shadow-md">
                    <span className="inline-block rounded-full bg-red-100 px-3 py-1 text-sm font-semibold text-red-800 mr-2 ring ring-red-200">Rupture</span>
                    </div>
                )}
                </div>
            )
